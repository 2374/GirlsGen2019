...
public class RobotMap {
	...
	public static final int CLIMBER_PORT_FORWARD = 1;
	public static final int CLIMBER_PORT_REVERSE = 2;
	...
	public static final int CONTROLLER_RIGHT_AXIS_X = 4;
	public static final int CONTROLLER_RIGHT_AXIS_Y = 5;
